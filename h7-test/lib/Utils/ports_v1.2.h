...
#define RNG_SENSOR_SDA      PF_0  // I2C
#define RNG_SENSOR_SCL      PF_1  // I2C
#define RNG_SENSOR_XSHUT1   PE_1  // GPIO -> XSHUT NUMBERS SET ACCORDING TO THE SCHEMATICS
#define RNG_SENSOR_XSHUT2   PF_8  // GPIO
#define RNG_SENSOR_XSHUT3   PE_5  // GPIO
